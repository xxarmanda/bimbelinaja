...
class SettingController extends Controller
{
    ...
    public function update(Request $request)
    {
        $request->validate([
            ...
            // FIELD BARU: SEKSI TUTOR MARQUEE
            ...
            // Field lainnya tetap (Hubungi Kami & Karir)
        ...
        if ($request->filled('youtube_url')) {
            ...
            Setting::updateOrCreate(['key' => 'youtube_video_id'], ['value' => $videoId]);
        }
    ...
    public function destroyVideo()
    {
        ...
        if ($setting) { $setting->update(['value' => null]); }
