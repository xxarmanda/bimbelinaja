<x-admin-layout>
    <div class="space-y-10">
        ...
        <div class="bg-white rounded-[3rem] p-12 shadow-sm border border-gray-50">
            <form action="{{ route('admin.sub-programs.store') }}" method="POST" enctype="multipart/form-data" class="space-y-12">
                ...
                <div class="grid md:grid-cols-2 gap-10 pt-10 border-t border-gray-100">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="relative group">
                             <div class="w-full p-4 rounded-xl bg-gray-50 border-2 border-dashed border-gray-200 text-gray-400 text-sm flex items-center justify-between group-hover:bg-teal-50 transition-colors">
                                 <span>Upload Ikon Level (JPG/PNG)</span>
                                 <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-8l-4-4m0 0L8 8m4-4v12"></path></svg>
                             </div>
                             <input type="file" name="new_item_icon" accept="image/*" class="absolute inset-0 opacity-0 cursor-pointer">
                        </div>
                ...
                {{-- 5. BUILDER KUIS MULTI-SOAL (DIPERBAIKI) --}}
                <div class="bg-teal-50/50 p-10 rounded-[3rem] border border-dashed border-teal-300 space-y-8">
                    ...
                    {{-- Kontainer tempat soal-soal akan muncul --}}
                ...
                <div class="space-y-3 pt-6 border-t border-gray-100">
                    ...
                    <input type="file" name="image" required class="w-full p-4 rounded-2xl bg-gray-50 border-none text-gray-400 text-sm">
                </div>
    ...
    {{-- 8. JAVASCRIPT UNTUK DYNAMIC INPUT --}}
    <script>
        let questionCount = 1;
