...
<div class="max-w-5xl mx-auto pb-20">
    ...
    <form action="{{ route('admin.settings.video.update') }}" method="POST" class="space-y-10">
        ...
        <div class="bg-white p-10 rounded-[3rem] shadow-sm border border-gray-100 space-y-8">
            ...
            <div class="space-y-4">
                <label class="block text-[10px] font-black uppercase text-gray-400 ml-2">Link Video YouTube (Company Profile)</label>
                <input type="text" name="youtube_url" value="{{ $settings['youtube_video_id'] ?? '' }}" placeholder="https://www.youtube.com/watch?v=..." class="w-full p-5 rounded-2xl border-2 border-gray-100 bg-[#F8FAFC] focus:border-[#006064] outline-none font-bold text-[#006064]">
            </div>
    ...
    <div class="mt-12 pt-8 border-t border-red-50 flex flex-col md:flex-row items-center justify-between bg-red-50/50 p-8 rounded-[2.5rem] gap-6">
        <div class="flex items-center space-x-5">
            ...
            <div class="text-center md:text-left">
                ...
                <p class="text-[10px] text-gray-400 font-bold uppercase italic leading-tight">Video YouTube yang aktif akan dihapus permanen <br class="hidden md:block"> dari database dan halaman utama.</p>
            </div>
        </div>
