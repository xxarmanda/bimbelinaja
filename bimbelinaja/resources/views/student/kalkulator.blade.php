            ...
            <div class="bg-white rounded-[2.5rem] md:rounded-[3rem] shadow-2xl border border-gray-100 p-8 md:p-16 space-y-10">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                    <div>
                        ...
                        <select name="learning_method" x-model="learningMethod" @change="showSummary = true" class="w-full bg-[#F8FAFC] border-2 border-transparent focus:border-[#006064] focus:bg-white rounded-3xl px-8 py-5 outline-none transition-all font-bold text-sm text-[#006064] appearance-none cursor-pointer">
                    ...
                    <div>
                        ...
                        <select name="sessions" x-model="sessions" @change="showSummary = true" class="w-full bg-[#F8FAFC] border-2 border-transparent focus:border-[#006064] focus:bg-white rounded-3xl px-8 py-5 outline-none transition-all font-bold text-sm text-[#006064] appearance-none cursor-pointer">
                    ...
                    <div>
                        ...
                        <select name="participants_count" x-model="participants" @change="showSummary = true" class="w-full bg-[#F8FAFC] border-2 border-transparent focus:border-[#006064] focus:bg-white rounded-3xl px-8 py-5 outline-none transition-all font-bold text-sm text-[#006064] appearance-none cursor-pointer">
