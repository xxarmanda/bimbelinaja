...
<body class="font-sans antialiased bg-gray-50 text-gray-900 overflow-x-hidden" x-data="{ sidebarOpen: false }">
    ...
    {{-- OVERLAY MOBILE: Klik di luar untuk tutup menu --}}
            ...
            <nav class="flex-1 px-4 space-y-1 mt-4">
                ...
                <div class="pb-4">
                    ...
                    <a href="{{ route('admin.dashboard') }}" 
                       class="flex items-center space-x-3 p-3 rounded-xl transition-all {{ request()->routeIs('admin.dashboard') ? 'bg-teal-50 text-[#006064] border-r-4 border-yellow-400' : 'text-gray-500 hover:bg-gray-100 hover:text-[#006064]' }}">
                ...
                <div class="pb-4">
                    ...
                    <a href="{{ route('admin.programs.index') }}" class="flex items-center space-x-3 p-3 rounded-xl transition-all {{ request()->routeIs('admin.programs.*') ? 'bg-teal-50 text-[#006064] border-r-4 border-yellow-400' : 'text-gray-500 hover:bg-gray-100' }}">
                    ...
                    <a href="{{ route('admin.sub-programs.index') }}" class="flex items-center space-x-3 p-3 rounded-xl transition-all {{ request()->routeIs('admin.sub-programs.*') ? 'bg-teal-50 text-[#006064] border-r-4 border-yellow-400' : 'text-gray-500 hover:bg-gray-100' }}">
                    ...
                    <a href="{{ route('admin.tutors.index') }}" class="flex items-center space-x-3 p-3 rounded-xl transition-all {{ request()->routeIs('admin.tutors.*') ? 'bg-teal-50 text-[#006064] border-r-4 border-yellow-400' : 'text-gray-500 hover:bg-gray-100' }}">
                    ...
                    <a href="{{ route('admin.service-areas.index') }}" class="flex items-center space-x-3 p-3 rounded-xl transition-all {{ request()->routeIs('admin.service-areas.*') ? 'bg-teal-50 text-[#006064] border-r-4 border-yellow-400' : 'text-gray-500 hover:bg-gray-100' }}">
                ...
                <div class="pb-4">
                    ...
                    <a href="{{ route('admin.sliders.index') }}" class="flex items-center space-x-3 p-3 rounded-xl transition-all {{ request()->routeIs('admin.sliders.*') ? 'bg-teal-50 text-[#006064] border-r-4 border-yellow-400' : 'text-gray-500 hover:bg-gray-100' }}">
                    ...
                    <a href="{{ route('admin.settings.index') }}" class="flex items-center space-x-3 p-3 rounded-xl transition-all {{ request()->routeIs('admin.settings.*') ? 'bg-teal-50 text-[#006064] border-r-4 border-yellow-400' : 'text-gray-500 hover:bg-gray-100' }}">
                    ...
                    <a href="{{ route('admin.media-coverages.index') }}" class="flex items-center space-x-3 p-3 rounded-xl transition-all {{ request()->routeIs('admin.media-coverages.*') ? 'bg-teal-50 text-[#006064] border-r-4 border-yellow-400' : 'text-gray-500 hover:bg-gray-100' }}">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path d="M19 20H5a2 2 0 01-2-2V6a2 2 0 012-2h10a2 2 0 012 2v1m2 13a2 2 0 01-2-2V7m2 13a2 2 0 002-2V9a2 2 0 00-2-2h-2m-4-3H9M7 16h6M7 8h6v4H7V8z" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path></svg>
                        <span class="font-bold text-sm">Media Coverage</span>
                    </a>
                    <a href="{{ route('admin.missions.index') }}" class="flex items-center space-x-3 p-3 rounded-xl transition-all {{ request()->routeIs('admin.missions.*') ? 'bg-teal-50 text-[#006064] border-r-4 border-yellow-400' : 'text-gray-500 hover:bg-gray-100' }}">
                    ...
                    <a href="{{ route('admin.student-testimonials.index') }}" class="flex items-center space-x-3 p-3 rounded-xl transition-all {{ request()->routeIs('admin.student-testimonials.*') ? 'bg-teal-50 text-[#006064] border-r-4 border-yellow-400' : 'text-gray-500 hover:bg-gray-100' }}">
                    ...
                    {{-- MENU LES ONLINE DI SIDEBAR --}}
                    <a href="{{ route('admin.online-settings.index') }}" 
                    class="flex items-center space-x-3 p-3 rounded-xl transition-all {{ request()->routeIs('admin.online-settings.*') ? 'bg-teal-50 text-[#006064] border-r-4 border-yellow-400' : 'text-gray-500 hover:bg-gray-100' }}">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 17h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path>
                        </svg>
                        {{-- PERBAIKAN: Tambahkan font-bold di sini agar teks selalu tebal --}}
                ...
                <div class="pb-4">
                    ...
                    <a href="{{ route('admin.transactions.index') }}" class="flex items-center justify-between p-3 rounded-xl transition-all {{ request()->routeIs('admin.transactions.*') ? 'bg-teal-50 text-[#006064] border-r-4 border-yellow-400' : 'text-gray-500 hover:bg-gray-100' }}">
                    ...
                    <a href="{{ route('admin.payment-configs.index') }}" class="flex items-center space-x-3 p-3 rounded-xl transition-all {{ request()->routeIs('admin.payment-configs.*') ? 'bg-teal-50 text-[#006064] border-r-4 border-yellow-400' : 'text-gray-500 hover:bg-gray-100' }}">
                    ...
                    <a href="{{ route('admin.benefits.index') }}" class="flex items-center space-x-3 p-3 rounded-xl transition-all {{ request()->routeIs('admin.benefits.*') ? 'bg-teal-50 text-[#006064] border-r-4 border-yellow-400' : 'text-gray-500 hover:bg-gray-100' }}">
                    ...
                    <a href="{{ route('admin.registration-steps.index') }}" class="flex items-center space-x-3 p-3 rounded-xl transition-all {{ request()->routeIs('admin.registration-steps.*') ? 'bg-teal-50 text-[#006064] border-r-4 border-yellow-400' : 'text-gray-500 hover:bg-gray-100' }}">
                    ...
                    <a href="{{ route('admin.contact.settings') }}" class="flex items-center space-x-3 p-3 rounded-xl transition-all {{ request()->routeIs('admin.contact.settings') ? 'bg-teal-50 text-[#006064] border-r-4 border-yellow-400' : 'text-gray-500 hover:bg-gray-100' }}">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path><path d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path></svg>
                        <span class="font-bold text-sm">Hubungi Kami</span>
                    </a>
                    <a href="{{ route('admin.messages.index') }}" class="flex items-center justify-between p-3 rounded-xl transition-all {{ request()->routeIs('admin.messages.*') ? 'bg-teal-50 text-[#006064] border-r-4 border-yellow-400' : 'text-gray-500 hover:bg-gray-100' }}">
                        <div class="flex items-center space-x-3">
        ...
        <main class="flex-1 min-h-screen transition-all duration-300 lg:ml-72">
            ...
            <header class="sticky top-0 z-30 bg-white/80 backdrop-blur-md border-b border-gray-100 p-6 lg:p-8 flex items-center justify-between">
                <div class="flex items-center space-x-4">
                    {{-- TOMBOL HAMBURGER (MUNCUL DI MOBILE SAJA) --}}
